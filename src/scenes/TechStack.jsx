...
const techstack2 =[
  img9,img10,img12,img13,img14,img15,img16,img17
]
  ...
  return (
    <section id="techstack" className="pt-16 pb-16">
      ...
      <motion.div
        ...
        >
      <div className="md:flex md:justify-between bg-blue gap-8 md:gap-8 mt-10 p-10">
      ...
      <motion.div
        ...
        >
      <div className="md:flex md:justify-between bg-blue gap-8 mt-10 p-10">
      {techstack2.map((val,index)=>{
        return (
        <motion.div
          className="mx-auto relativ flex flex-col justify-center"
          initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }}
